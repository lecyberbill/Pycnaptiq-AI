...
with gr.Blocks(**block_kwargs) as interface:
    ...
    gr.Markdown(f"# Cyberbill SDXL images generator version {version()}", elem_id="main_title_markdown") # Added elem_id for potential future use
...
interface.launch(inbrowser=str_to_bool(OPEN_BROWSER), pwa=True, share=str_to_bool(SHARE), allowed_paths=[SAVE_DIR])
>>>>>>> 701c021b308250d6eb637597b1b95d6198a60077
