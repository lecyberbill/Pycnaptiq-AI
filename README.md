...
2.  **Civitai Downloader** (New in Beta 1.8.7)
...
3.  **Image Watermark** (New in Beta 1.8.7)
...
4.  **Sana Sprint** (New in Beta 1.8.6)
...
5.  **Image Enhancement** (New in Beta 1.8.5)
...
6.  **Batch Generator & Runner** (Functionality from Beta 1.8)
